...
**Skills** (`.claude/skills/`, `.codex/skills/`) — 16 mirrored skill directories: coding standards per language, model-specific prompting (`fable-5-prompting`, `opus-5-prompting`, `gpt-5-6-prompting`, `gemini-3-prompting`), domain skills (`ticket-writing`, `plantuml-diagramming`, `rest-api`), and behavioral modes (`minimal-coding`).
